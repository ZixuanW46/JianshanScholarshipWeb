...
export default function ChinaTripCrew() {
    return (
                ...
                <div className="flex flex-col md:flex-row gap-6 md:gap-8 min-h-[400px]">
                    ...
                    >
                        ...
                        <p className="text-xl md:text-2xl font-serif italic text-[#1A4D2E] relative z-10 mt-12 md:max-w-lg leading-snug">
                            Each cohort consists of 10–20 Cambridge members from around the world, accompanied by Chinese Cambridge students who act as your local travel guides. You'll explore together, eat together, and build friendships that last long after the trip.
                        </p>
                    ...
                    >
                        ...
                        <p className="text-[#FDFBF7]/80 font-light text-base md:text-lg leading-relaxed relative z-10 mt-8">
                            You'll have dedicated free time to discover your own China — while your experienced travel guides and fellow crew members are always just a message away. We handle logistics, you focus on the adventure.
                        </p>
